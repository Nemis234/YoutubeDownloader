...
class Window(tk.Tk):
    ...
    def __init__(self, size:tuple=(450,280),size_scale: int=1.5) -> None:
        ...
        def start_download(event=None):
            ...
            audio_number = video_number = False
            ...
            return self.initDownload(self.yt,video_number)
        ...
        row = 3
        button1 = tk.Button(self,text="Submit link",command=submit_link,bg = Window.button_color,font=font)
    ...
    def initDownload(self,yt:object,video_stream_no:int=None, audio_stream_no:int=None,will_concate:bool = False):
        ...
        print(f"Starting download, videonr:{video_stream_no},audionr:{audio_stream_no}")
        DownloadGUI(self,(yt,video_stream_no,audio_stream_no,directory,filename),will_concate).run()
